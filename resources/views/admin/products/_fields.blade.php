...
<div class="form-group {{ $errors->has('sku') ? 'has-error' : '' }}">
    {{ Form::label('sku', 'SKU') }}
    {{ Form::text('sku',$product->sku,['class'=>'form-control border-input','placeholder'=>'sku']) }}
    <span class="text-danger">{{ $errors->has('sku') ? $errors->first('sku') : '' }}</span>
</div>
<div class="form-group {{ $errors->has('category') ? 'has-error' : '' }}">
    {{ Form::label('category', 'Category Name') }}
    {{ Form::text('category',$product->category,['class'=>'form-control border-input','placeholder'=>'Category Name']) }}
